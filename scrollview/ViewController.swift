...
class ViewController: UIViewController,UIScrollViewDelegate{
    ...
    var titles = ["Learn from the best in the industry","Learn on the go anythime, anywhere","Resolve the doubts with the TA's & Mentors"]
...
//       browseCourse.layer.cornerRadius = 25.0
       ...
       for index in 0..<titles.count {
        ...
        imageView.contentMode = UIView.ContentMode.scaleAspectFit
              ...
              let txt1 = UILabel.init(frame: CGRect(x:32,y:imageView.frame.minY-70,width:scrollWidth-64,height:60))
